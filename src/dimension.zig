...
pub const Dimension = struct {
    ...
    pub fn copyFrom(self: *Self, source: *const Self) Allocator.Error!void {
        const allocator = self.allocator;
    ...
    pub fn copyWithName(self: *const Self, name: ?[]const u8) Allocator.Error!*Self {
    ...
    fn factorsEqual(a: Self, b: Self, side: FactorSide) bool {
        ...
        for (a_factors) |factor| {
            ...
            for (b_factors) |other| {
                if (!std.mem.eql(u8, factor.name, other.name))
                    continue;
    ...
    pub fn equal(a: Self, b: Self) bool {
        return factorsEqual(a, b, .numerator) and
            factorsEqual(a, b, .denominator);
    }
    ...
    pub fn combine(
        ...
        const b_numerator_side: FactorSide = switch (operation) {
            .mul => .numerator,
            .div => .denominator,
        };
    ...
    pub fn writeUnits(self: *const Self, io: *const std.Io) !void {
